...
public class Investigadores {
	...
	public static void createTable(String db, String name) {
		try {
			...
			String Query = "CREATE TABLE " + name + "" + "(DNI VARCHAR(8) PRIMARY KEY, NomApels VARCHAR(255), Facultad INT, FOREIGN KEY (Facultad) REFERENCES Facultad(ID))";
	...
	public static void insertData(String db, String table_name, String DNI, String NomApels, Integer Facultad) {
		try {
			String Querydb = "USE " + db + ";";
			Statement stdb = connectionBase.conexion.createStatement();
			stdb.executeUpdate(Querydb);
