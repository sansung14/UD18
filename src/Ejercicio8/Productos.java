...
public class Productos {
	...
	public static void createTable(String db, String name) {
		try {
			...
			String Query = "CREATE TABLE " + name + "" + "(ID INT PRIMARY KEY AUTO_INCREMENT, Nombre VARCHAR(255), Precio INT)";
	...
	public static void insertData(String db, String table_name, String Nombre, Integer Precio) {
		try {
			String Querydb = "USE " + db + ";";
			Statement stdb = connectionBase.conexion.createStatement();
			stdb.executeUpdate(Querydb);
