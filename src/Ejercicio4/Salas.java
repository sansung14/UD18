...
public class Salas {
		...
		public static void createTable(String db, String name) {
			try {
				...
				String Query = "CREATE TABLE " + name + ""
						+ "(ID INT PRIMARY KEY AUTO_INCREMENT, Nombre VARCHAR(100), Pelicula INT, FOREIGN KEY (Pelicula) REFERENCES Peliculas(ID))";
		...
		public static void insertData(String db, String table_name, String Nombre , Integer Pelicula) {
			try {
				String Querydb = "USE " + db + ";";
				Statement stdb = connectionBase.conexion.createStatement();
				stdb.executeUpdate(Querydb);
